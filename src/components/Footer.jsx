  ...
  return (
    <div>
        <div className='logo_and_undertaking flex flex-col items-center bg-gray-900 text-white lg:px-10 md:px-6 px-4 text-center py-9 lg:gap-8 md:gap-8 gap-4'>
            ...
            <p className='text-md font-semibold lg:w-3/4 md:w-3/4 w-full'>We are specialists in property management. We pride ourselves on delivering outstanding quality and service; we make it a pleasure to be a tenant and profitable to be a landlord.
            </p>
